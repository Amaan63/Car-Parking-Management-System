...
<div class="container mt-5">
	<div class="row">
		...
		<div class="col-md-6">
			<img src="images/Short-Bio.svg" alt="Short Bio" class="img-fluid"
				id="img" />
		</div>
	</div>
</div>
...
<div class="container mt-5">
	<div class="row">
		<div class="col-md-6">
			<img src="images/Everything-Online.svg" alt="Everything-Online" class="img-fluid"
				id="img" style="height: 500px;width: 500px"/>
		</div>
		<div class="col-md-6 d-flex align-items-center">
			<div>
