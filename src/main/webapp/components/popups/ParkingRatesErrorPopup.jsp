...
<div class="popup" id="popupMessage">
	<div class="popup-content">
		<span class="popup-close" id="popupClose">&times;</span> <img
			...
			src="images/Login&Registration/WrongCrediantials.png" alt="wrongCrediantials" 
			class="popup-image">
			
		<h3  style="color: red;">Failed to Create Parking Rates</h3>
		<p style="color: black;">Something Went Wrong Please Try again After some time</p>
	</div>
</div>
<script>
