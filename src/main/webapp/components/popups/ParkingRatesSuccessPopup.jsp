...
<div class="popup" id="popupMessage">
	<div class="popup-content">
		<span class="popup-close" id="popupClose">&times;</span> <img
			src="../images/Icons/PaymentDone.png" alt="Rate is Successfully Set"
			class="popup-image">
		<h3  style="color: green;">Successfully Updated Parking Rates</h3>
		<p style="color: black;">Rates are Added Successfully </p>
	</div>
</div>
<script>
