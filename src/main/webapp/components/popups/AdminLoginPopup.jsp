...
<div class="popup" id="popupMessage">
	<div class="popup-content">
		<span class="popup-close" id="popupClose">&times;</span> <img
			src="../videos/AnimatedLogo/AdminLoginSuccessful.gif" alt="AdminLoginSuccessful"
			class="popup-image">
		<h3  style="color: green;">Successfully Logged In As Admin</h3>
		<p style="color: black;">Welcome Admin!!!!!!</p>
	</div>
</div>
<script>
