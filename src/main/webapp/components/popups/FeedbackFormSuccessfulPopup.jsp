...
<div class="popup" id="popupMessage">
	<div class="popup-content">
		<span class="popup-close" id="popupClose">&times;</span><img
			src="<%=request.getContextPath()%>/videos/AnimatedLogo/FeedbackSuccessful.gif"
			alt="AdminLoginSuccessful" class="popup-image">

		<h3 style="color: green;">Feedback Submitted!</h3>
		<p style="color: black;">Your feedback has been recorded
