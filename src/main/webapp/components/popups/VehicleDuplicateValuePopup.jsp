...
<div class="popup" id="popupMessage">
	<div class="popup-content">
		<span class="popup-close" id="popupClose">&times;</span> <img
			src="../images/Login&Registration/DuplicateValue.png"
			alt="Duplicate Value" class="popup-image">

		<h3 style="color: red;">Error: Duplicate Vehicle Number</h3>
		<p style="color: black;">This vehicle number is already
			registered. Try a different one.</p>
